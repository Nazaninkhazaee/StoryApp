...
class ItemAdapter(val storyTitles: Array<String>,
                  val storyContents: Array<String>,
                  val storyImages: Array<String> ) : RecyclerView.Adapter<ItemAdapter.ViewHolder>() {
...
//            Toast.makeText(holder.view.context,"item number -> "+ position,
//                Toast.LENGTH_SHORT).show()
            val intent = Intent(it.context,DeatilsActivity::class.java)
